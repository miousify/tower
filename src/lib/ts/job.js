...
var Job = /** @class */ (function () {
    ...
    Job.getAxiosInstance = function () {
        return Job.AXIOS.create({ baseURL: "", httpAgent: "", timeout: 2000, headers: {} });
    };
    Job.prototype.createJob = function (newJob) {
        return __awaiter(this, void 0, void 0, function () {
            var planConfig, ownerDetails;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Job.getAxiosInstance().get("/admin")];
                    case 1:
                        planConfig = _a.sent();
                        return [4 /*yield*/, Job.getAxiosInstance().get("/store/" + newJob._id)
                            // Check if expired
                            // if not expired begin process;
                        ];
                    case 2:
                        ownerDetails = _a.sent();
                        // Check if expired
                        // if not expired begin process;
    ...
    Job.prototype.removeJob = function () {
    };
    Job.prototype.updateJob = function () {
    };
